...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    WHERE tablename = 'question_feedback' AND policyname = 'Users can insert their own feedback'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'question_feedback' AND policyname = 'Users can view their own feedback'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'question_feedback' AND policyname = 'Admins can view all feedback'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'question_feedback' AND policyname = 'Admins can update feedback'
  ) THEN
